...
class exports.LayerDraggable extends BaseClass
	...
	_touchStart: (event) =>
		...
		@layer._element.addEventListener(Events.TouchMove, @_touchMove)
		@layer._element.addEventListener(Events.TouchEnd, @_touchEnd)
	...
	_touchEnd: (event) =>
		...
		@layer._element.removeEventListener(Events.TouchMove, @_touchMove)
		@layer._element.removeEventListener(Events.TouchEnd, @_touchEnd)
